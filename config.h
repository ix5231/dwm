...
static const char *fonts[]          = { "t cherry:size=10", "umplus Gothic Wide:size=10" };
...
static const char *incvol[] = { "ponymix", "increase", "5", NULL };
static const char *decvol[] = { "ponymix", "decrease", "5", NULL };
static const char *mute[] = { "ponymix", "toggle", NULL };
